...
public class MemberExceptionHandler {
    ...
    public ResponseEntity<String> handleDuplicateMemberEmailException(MemberNotFoundException ex){
        return new ResponseEntity<>(ex.getMessage(), ex.getStatus());
    }
    @ExceptionHandler(DuplicateMemberNicknameException.class)
    public ResponseEntity<String> handleDuplicateMemberNicknameException(MemberNotFoundException ex){
        return new ResponseEntity<>(ex.getMessage(), ex.getStatus());
    }
}
